        ...
        try {
            ...
            if (valuesOnly != null && typeof valuesOnly === "object" && valuesOnly.length > 0) {
                for (const v of valuesOnly) {
                    ...
                    if (v?.propertyKeyName && constant.MEANINGFUL_PROPERTY_KEYS[v.commandClassName]?.includes(v.propertyName)) {
                    ...
                    if ((v.value === undefined || v.value === null) && !v.metadata?.writeable) {
                        continue;
                    }
